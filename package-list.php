...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> DZ- Lista de paquetes</h1>
	</div>
</div>
<!--- /banner ---->
<!--- rooms ---->
...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-6 room-midle wow fadeInUp animated" data-wow-delay=".5s">
					<h4>Nombre del Hotel: <?php echo htmlentities($result->PackageName);?></h4>
					<h6>Tipo de Hotel : <?php echo htmlentities($result->PackageType);?></h6>
					<p><b>Locación :</b> <?php echo htmlentities($result->PackageLocation);?></p>
