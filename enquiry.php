...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">DZ- Dream Zone Gestión Hotelera</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
...
<p style="width: 350px;">
<b>Correo</b>  <input type="email" name="email" class="form-control" id="email" placeholder="Validacion de correo" required="">
	</p> 

	<p style="width: 350px;">
<b>No. Celular</b>  <input type="text" name="mobileno" class="form-control" id="mobileno" maxlength="10" placeholder="Num telfonico" required="">
	</p> 
