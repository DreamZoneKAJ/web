...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">DZ-Sistema de Gestión Hotelera</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
<div class="privacy">
	...
	<p style="width: 350px;">
			...
			<b>Num. Telf</b>  <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Ingrese número celular" required="">
	</p> 
