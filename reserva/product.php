       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>SERVICIOS <small class="tittles-pages-logo">Dream Zone</small></h1>
            </div>
            <?php
              ...
              <div class="row">
                <?php
                  ...
                  if(mysqli_num_rows($consultar_productos)>=1){
                    echo '<h3 class="text-center">Se muestran los SERVICIOS de la categoría <strong>"'.$datCat['Nombre'].'"</strong></h3><br>';
                ...
                <?php
                    ...
                    echo '<h2 class="text-center">Lo sentimos, no hay SERVICIOS registrados en la categoría <strong>"'.$datCat['Nombre'].'"</strong></h2>';
                  }
                ?>
              </div>
            <?php
                ...
                echo '<h2 class="text-center">Lo sentimos, no hay SERVICIOS ni categorías registradas en la tienda</h2>';
              endif;
            ?>
        </div>
    </section>
