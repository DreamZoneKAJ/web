       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>BÚSQUEDA DE SERVICIOS <small class="tittles-pages-logo">Dream Zone</small></h1>
            </div>
              ...
              <div class="container-fluid">
                <div class="row">
                  ...
                  <?php
                      ...
                      echo '<h2 class="text-center">Lo sentimos, no hemos encontrado servicios con el nombre, marca o modelo <strong>"'.$search.'"</strong></h2>';
                    }
                  ?>
                </div>
              </div>
            <?php
                  ...
                  echo '<h2 class="text-center">Por favor escriba el nombre del servicio  que desea buscar</h2>';
              }
            ?>
        </div>
    </section>
