	...
	if($oldPass!="" && $newPass!="" && $newPass2!=""){
		if($newPass!=$newPass2){
			...
			if(mysqli_num_rows($CheckLog)==1){
				$newPass=md5($newPass);
				$campos="Nombre='$user',NombreCompleto='$Nombre',Apellido='$Apellido',Clave='$newPass',Telefono='$Telefono',Email='$Email'";
			}else{
		...
		$campos="Nombre='$user',NombreCompleto='$Nombre',Apellido='$Apellido',Telefono='$Telefono',Email='$Email'";
	}
