<?php
    ...
    if(mysqli_num_rows($checP)<=0){
        if(consultasSQL::DeleteSQL('producto', "CodigoProd='".$codeProd."'")){
            ...
            echo '<script>
                swal({
                  ...
                  text: "El Servicio se eliminó con éxito de DREAMZONE",
                  type: "success",
        ...
        echo '<script>swal("ERROR", "No podemos eliminar el SERVICIO porque se encuentra registrado en una venta", "error");</script>';
    }
