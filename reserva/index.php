    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="eventos.jpg" alt="slider1">
                <div class="carousel-caption">
                    Eventos exclusivos
                </div>
            </div>
            <div class="item">
                <img src="aventure.jpg" alt="slider2">
                <div class="carousel-caption">
                    Aventuras grandiosas
                </div>
            </div>
            <div class="item">
                <img src="spe.jpg" alt="slider3">
                <div class="carousel-caption">
                    Relajación al maximo
                </div>
            </div>
        </div>
    ...
    <section id="new-prod-index">    
         <div class="container">
            <div class="page-header">
                <h1>Últimos <small>SERVICIOS agregados</small></h1>
            </div>
            <div class="row">
              	<?php
                ...
                <?php
                      ...
                      echo '<h2>No hay SERVICIOSs registrados en la tienda</h2>';
                  }  
              	?>  
            </div>
         </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo">Dream Zone</span> en un sencillo formulario para poder completar tus SERVICIOS o eventos</p>
