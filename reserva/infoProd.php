        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                    <h1>DETALLE DE PRODUCTO <small class="tittles-pages-logo">Dream Zone</small></h1>
                </div>
                <?php 
                                ...
                                if($fila['Stock']>=1){
                                    if($_SESSION['nombreAdmin']!="" || $_SESSION['nombreUser']!=""){
                                        echo '<form action="process/carrito.php" method="POST" class="FormCatElec" data-form="">
                                            ...
                                            <label class="text-center"><small>Agrega la cantidad de SERVICIOS que añadiras al carrito de compras (Maximo '.$fila['Stock'].' productos)</small></label>
                                        ...
                                        echo '<p class="text-center"><small>Para agregar SERVICIOS al carrito de compras debes iniciar sesion</small></p><br>';
