...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    <li>
        <a href="configAdmin.php?view=category">
            <i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp; Nueva Servicios
        </a>
    </li>
    <li>
        <a href="configAdmin.php?view=categorylist"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Categoría de Servicioss</a>
    </li>
</ul>
<div class="container">
	<div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                <h3 class="text-info text-center">Actualizar datos de Categoria de Servicios</h3>
                <?php
                	$code=$_GET['code'];
                ...
                <form action="./process/updateCategory.php" method="POST" class="FormCatElec" data-form="update">
                    ...
                    <p class="text-center"><button type="submit" class="btn btn-primary btn-raised">Actualizar Categoria de Servicios</button></p>
                </form>
            </div>
        </div>
    </div>
