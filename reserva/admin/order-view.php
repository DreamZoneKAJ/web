  ...
  <div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel panel-info">
                <div class="panel-heading text-center"><h4>Pedidos de Dream Zone</h4></div>
                        ...
                        <thead class="">
                            <tr>
                              <th class="text-center">#</th>
                                ...
                                <th class="text-center">Entrega de Servicio</th>
  ...
  <div class="modal-dialog modal-sm">
      <div class="modal-content" style="padding: 15px;">
        <div class="modal-header">
          ...
          <h5 class="modal-title text-center text-primary" id="myModalLabel">Actualizar estado del Servicio</h5>
        </div>
