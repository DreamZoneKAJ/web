...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="configAdmin.php?view=productlist"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Servicios de Dream Zone</a>
    </li>
</ul>
<div class="container">
	<div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                <h3 class="text-primary text-center">Agregar un Servico a la tienda</h3>
                <form action="./process/regproduct.php" method="POST" enctype="multipart/form-data" class="FormCatElec" data-form="save">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">Nombre del Paquete del Servios</label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">Modelo del servicio</label>
                            ...
                            <div class="col-xs-12">
                                <legend>Imagen/Foto del Servicio</legend>
                ...
                <p class="text-center"><button type="submit" class="btn btn-primary btn-raised">Agregar Servicio</button></p>
                </form>
            </div>
        </div>     
    </div>
